...
const EnvantoKivilabVerify = async (page, locator) => {
    ...
    const verifytext = await iqonicDesignSpanLocator.textContent();
    expect(verifytext).toContain('KiviLabs - Complete Laboratory Management System with Booking');
    return newPage;
}
...
module.exports = { UserAppPlaystore, AdminPanelVerify, BookcallVerify, TrustpilotVerify, EnvantoVerify, EnvantoKivilabVerify, UserAppAppstore, CollectorAppPlaystore, CollectorAppAppstore, CommonLinkVerify }